...
const projects = [
  "/assets/Service_image/project1.jpg", 
...
export default function Service() {
  ...
  return (
    <div ref={containerRef} className="w-full bg-white text-black">
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 pt-32 pb-20">
        <div className="text-center mb-24 animate-scroll">
          <HoverCursor variant="big">
            <h1 className="text-[7vw] md:text-[5.5rem] font-bold leading-[0.95] tracking-tight mx-auto max-w-4xl">
        ...
        {/* Small text block */}
        <div className="max-w-[500px] text-lg md:text-xl text-gray-500 leading-relaxed mb-20 animate-scroll">
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 mb-32 animate-scroll">
        <div className="max-w-2xl">
            <HoverCursor variant="big">
                <h2 className="text-[8vw] md:text-[4.5rem] font-bold leading-[1] tracking-tight mb-10">
                    Part of your team,<br />
                    from start to finish
                </h2>
            </HoverCursor>
            <div className="max-w-lg text-lg text-gray-500 leading-relaxed">
                <p>
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 mb-40">
        
        <div className="mb-20 animate-scroll">
             <h2 className="text-[8vw] md:text-[4.5rem] font-bold leading-[0.9] tracking-tight text-right md:text-right">
        ...
        <div className="flex flex-col md:flex-row gap-20 items-start">
            ...
            <div className="w-full md:w-1/2 sticky top-32 animate-scroll">
                 <div className="w-full aspect-square border border-gray-200 relative flex items-center justify-center p-10">
      ...
      {/* --- 4. WHY WORK WITH US --- */}
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 mb-40 animate-scroll">
        <h2 className="text-[8vw] md:text-[4.5rem] font-bold leading-[1] tracking-tight mb-12">
            Why work with us
        </h2>
      ...
      <section className="w-full mb-40">
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-10 mb-20 text-center animate-scroll">
            <HoverCursor variant="big">
                ...
                {/* Images Stack */}
        <div className="flex flex-col gap-10 px-6 md:px-10 max-w-[1400px] mx-auto">
